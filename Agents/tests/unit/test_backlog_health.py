"""Hermetic tests for the backlog-health agent package (no LLM calls)."""
...
from backlog_health.registry import SUPPORTED_FRAMEWORKS, build_agent


def test_contract_identity() -> None:
    assert AGENT_KEY == "backlog_health"
    assert BacklogHealthAgent.category is RiskCategory.BACKLOG
