"""LangGraph adapter for the backlog-health agent (the default framework)."""
...
from backlog_health.prompts import SYSTEM_PROMPT, build_user_prompt
...
class LangGraphBacklogHealthAgent(BacklogHealthAgent):
    ...
    def _assess(self, state: _State) -> _State:
        ...
        for f in assessment.findings:
            ...
            findings.append(
                RiskFinding(
                    risk_category=RiskCategory.BACKLOG,
