"""LangGraph adapter for the resource-risk agent (the default framework)."""
...
from resource_risk.prompts import SYSTEM_PROMPT, build_user_prompt
...
class LangGraphResourceRiskAgent(ResourceRiskAgent):
