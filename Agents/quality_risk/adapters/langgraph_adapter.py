"""LangGraph adapter for the quality-risk agent (the default framework)."""
...
from quality_risk.prompts import SYSTEM_PROMPT, build_user_prompt
...
class LangGraphQualityRiskAgent(QualityRiskAgent):
