"""LangGraph adapter for the project-status-tracking agent (the default framework)."""
...
from project_status_tracking.prompts import SYSTEM_PROMPT, build_user_prompt
...
class LangGraphProjectStatusTrackingAgent(ProjectStatusTrackingAgent):
    ...
    def _assess(self, state: _State) -> _State:
        ...
        for f in assessment.findings:
            ...
            findings.append(
                RiskFinding(
                    risk_category=RiskCategory.DELIVERY,
