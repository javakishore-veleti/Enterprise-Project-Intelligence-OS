"""LangGraph adapter for the dependency-risk agent (the default framework)."""
...
from dependency_risk.prompts import SYSTEM_PROMPT, build_user_prompt
...
class LangGraphDependencyRiskAgent(DependencyRiskAgent):
