...
Uses pg8000 (pure-Python DB-API) so the service installs and runs without libpq.
DAOs depend only on the DB-API surface, so swapping to psycopg later is confined
to this module.
"""
